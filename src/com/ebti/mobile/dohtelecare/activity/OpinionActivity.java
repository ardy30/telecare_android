...
//				});
		...
		String webSiteStr = "http://mohw.telecare.com.tw/PMOMobileApp/Comment.aspx?UserID=" + getBundle.getString( "id" );
		...
		myBrowser.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				// loading error
				view.loadUrl(getString(R.string.webview_error_pageURL));
				pd.dismiss();
			}
...
//	               Toast.makeText(OpinionActivity.this, "Sorry!" + description,  
