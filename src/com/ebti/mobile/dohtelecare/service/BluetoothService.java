...
//    private static final UUID MY_UUID = UUID.fromString("00000003-0000-1000-8000-00805F9B34FB");
    ...
    private class AcceptThread extends Thread {
        ...
        private BluetoothServerSocket SetServerSocket()
        {
            ...
            try {
            	if (D) Log.d(TAG, "try accept Thread()");            	
            	tmp = mAdapter.listenUsingInsecureRfcommWithServiceRecord(NAME, MY_UUID);
/*
            	if (Build.VERSION.SDK_INT >= 10)	//get API Level
            	{
            		//Level 10, Android 2.3.3 support
            		tmp = mAdapter.listenUsingInsecureRfcommWithServiceRecord(NAME, MY_UUID);
            	//	tmp = mAdapter.listenUsingRfcommWithServiceRecord(NAME, MY_UUID);
            	}else
            	{
            		//Level 5, Android 2.2 support
            		tmp = mAdapter.listenUsingRfcommWithServiceRecord(NAME, MY_UUID);
            	}
*/            	
            } catch (IOException e) {
